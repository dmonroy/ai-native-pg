...
SELECT vector_dims(ai.embed('cat')) = 768 AS single_word_works;

-- Can embed sentence
SELECT vector_dims(ai.embed('The quick brown fox')) = 768 AS sentence_works;

-- Can embed paragraph
SELECT vector_dims(ai.embed('This is a longer text. It has multiple sentences. Testing paragraph embedding.')) = 768 AS paragraph_works;
